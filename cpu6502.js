...
function CPU6502(ram)
{
    ...
    var regP  = 0x20;   // Processor status
...
//            message("Stack empty");
    ...
    //
    // executes the code specified by addr
    //
    function go(addr, ms) {
        stop();
        reset();
        ...
        regPC = addr || 0x0600;
        interval_ms = (ms < 1) ? 1 : ms;

        interval = setInterval(multiexecute, interval_ms);
    }
    ...
    function set_instruction_rate(ms) {
...
//            message("program end at PC=$" + addr2hex(regPC-1));
    ...
    return {
        ...
        pause: pause,
        resume: resume,
        set_instruction_rate: set_instruction_rate,
        reset: reset
    };
}
